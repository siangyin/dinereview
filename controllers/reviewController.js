...
const getReviews = async (req, res) => {
	try {
		...
		if (userId && restaurantId) {
			...
			sql = `select reviews.reviewId, reviews.restaurantId, restaurants.name, reviews.userId, users.username, reviews.title, reviews.content, reviews.rating, reviews.status, reviews.createdOn from reviews left join restaurants on reviews.restaurantId = restaurants.restaurantId left join users on reviews.userId = users.userId`;
